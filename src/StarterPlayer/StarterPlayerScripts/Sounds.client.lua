...
--     warn(
--         'MININUM_SONGS_REQUIRED_BETWEEN_REPEATS is high enough that only one music sequence is possible (no randomization will occur)'
--     )
-- end
...
--                 local numIndexesToMoveForward =
--                     math.max(MININUM_SONGS_REQUIRED_BETWEEN_REPEATS - futureSongIndex - recentlyPlayedIndex + 2, 0)
--                 if numIndexesToMoveForward > 0 then
--                     table.remove(soundObjects, futureSongIndex)
--                     table.insert(
--                         soundObjects,
--                         math.min(#soundObjects + 1, futureSongIndex + numIndexesToMoveForward),
--                         futureSoundObject
--                     )
--                 end
--             end
